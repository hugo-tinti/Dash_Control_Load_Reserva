...
PALETA = {
    ...
    "barborde": "#343a40",
    "rojo": "#b22222",
    "rojoclaro": "rgba(178,34,34,0.8)",
    "azul": "#20639b",
    "azulline": "rgba(32,99,155,1.0)",
    "azulclaro": "rgba(30,144,255,0.6)",
    "azulborde": "rgba(30,144,255,1.0)",
    "amarillo": "#DAA520",
    "gris": "#6c757d",
    "grissuave": "#e9ecef",
    "verdearea": "rgba(0,128,0,0.10)",
    "amarilloarea": "rgba(255,215,0,0.12)",
    "rojoarea": "rgba(220,20,60,0.08)"
}
...
CONFIG_ANALISIS = {
    ...
    'jugadoresexcluir': [
        'Alan Laprida', 'Alexis Canelo', 'Braian Martinez', 'Jhony Quiones', 'Juan Manuel Fedorco'
    ],
    'variablesanalisis': [
        'Distancia Total', 'Tot 16', 'Dis 25', 'Mts Acc 3', 'Mts Dcc -3', 'Pot Met 20 Mts', 'Pot Met 55 Mts'
    ],
    'acrthresholds': {
        'low': 0.8,
        'high': 1.3
    ...
    'ratioaxismax': 2.5,
    'aosanalisis': [2024, 2025],
    'estilovisual': {
        'figurafacecolor': PALETA["fondo_fig"],
        'axesfacecolor': PALETA["fondo_axes"],
        'gridcolor': PALETA["grid"],
        'gridalpha': 0.8,
        'gridlinewidth': 1.2,
        'spinecolor': PALETA["borde"],
        'spinelinewidth': 2.2,
        'textocolor': PALETA["texto"],
        'bordecolor': PALETA["barborde"],
        'sombracolor': PALETA["sombra"],
        'titulocolor': PALETA["titulo"],
        'subtitulocolor': PALETA["subtitulo"],
    }
}
...
# Función para cargar los datos usando la configuración
@st.cache_data(show_spinner=False)
def cargar_datos():
    try:
        ruta = CONFIG_ANALISIS['rutas']['archivo_principal']
        ...
        logger.error(f"Error al cargar datos desde {ruta}: {e}")
        return None

# Aquí debería ir el resto de tu código, funciones, clases y lógica, 
# asegurándote que en vez de usar rutas absolutas, siempre uses 
# CONFIG_ANALISIS['rutas']['archivo_principal'] para acceder al archivo.

# Ejemplo de uso en la app Streamlit:
if __name__ == "__main__":
    st.title("Análisis Agudo-Crónico CAI")

    # Información para debugging entorno
    import os
    ...
    if datos is not None and not datos.empty:
        st.write(datos.head())
        # Aquí la continuación de la interfaz con tus análisis...
    else:
        st.warning("No hay datos para mostrar o hubo un error cargando el archivo.")
